...
st.write("""
    ...
    provided by SF DPW. The dataset is filtered by the owner of the
    tree as selected in the sidebar!
    """)
...
unique_owners = trees_df['caretaker'].unique()
owners = st.sidebar.multiselect(
    "Tree Owner Filter",
    unique_owners,
)
graph_color = st.sidebar.color_picker('Pick A Color', '#00f900')
if owners:
